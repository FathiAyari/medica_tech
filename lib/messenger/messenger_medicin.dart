...
import 'package:medica_tech/widgets/info_message.dart';

final snapshotMessages = FirebaseFirestore.instance;
ScrollController controller = new ScrollController();

class MessengerMedicin extends StatefulWidget {
  @override
  _MessengerState createState() => _MessengerState();
}

class _MessengerState extends State<MessengerMedicin> {
  String textMessage = "";
  String uid;
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        for (var message in messages) {
          ...
          if ((getSender == uid && getDestination == "patient@gmail.com") ||
              (getSender == "patient@gmail.com" && getDestination == uid)) {

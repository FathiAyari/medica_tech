...
class MessengerPatient extends StatefulWidget {
  @override
  _MessengerState createState() => _MessengerState();
}

class _MessengerState extends State<MessengerPatient> {
  String textMessage = "";
  String uid;
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        for (var message in messages) {
          ...
          if ((getSender == uid && getDestination == "medicin@gmail.com") ||
              (getSender == "medicin@gmail.com" && getDestination == uid)) {

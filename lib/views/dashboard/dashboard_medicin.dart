...
class DashBoardMedicin extends StatefulWidget {
  @override
...
var userCollection = FirebaseFirestore.instance
    .collection('folders')
    .where("treatement", isEqualTo: "Aucune");

class _DashbaordScreenState extends State<DashBoardMedicin> {
